...
export function FAQ() {
  ...
  return (
    <div className="bg-transparent py-16 md:py-32 px-4 md:px-8 lg:px-[351px]">
        <div className="text-center mb-12 md:mb-16">
            <h2 className="text-[32px] sm:text-[40px] md:text-[60px] leading-[1.1] md:leading-[54px] mb-4 text-[var(--foreground)]">
              <span className="italic">{t('faq.heading')}</span>
            </h2>
            <p className="italic text-[20px] sm:text-[24px] md:text-[30px] text-[var(--foreground)]" style={{ fontFamily: 'Instrument Serif, serif' }}>
              {t('faq.subtitle')}
            </p>
        </div>
        ...
        <div className="text-center mt-16 text-xs uppercase tracking-widest text-[var(--muted-foreground)]">
