...
import { ArrowRight, Upload, FileSearch, CheckCircle } from "lucide-react";
...
export function HowItWorks() {
  ...
  return (
    <div id="how-it-works" className="w-full bg-transparent py-16 md:py-32 relative">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16 md:mb-24">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gray-100 text-gray-500 mb-6 border border-gray-200">
              <span className="w-2 h-2 rounded-full bg-[#FE9170]"></span>
              <span className="text-xs font-bold uppercase tracking-widest">{t('howItWorks.badge')}</span>
            </div>
            <h2 className="text-3xl md:text-5xl lg:text-6xl text-[#0a0a0a] mb-6 leading-tight px-4" style={{ fontFamily: 'Instrument Serif, serif' }}>
              {t('howItWorks.title1')} <br className="hidden sm:block"/>
              <span className="italic text-[#FE9170]" style={{ fontFamily: 'Instrument Serif, serif' }}>{t('howItWorks.title2')}</span>
            </h2>
            <p className="text-base md:text-lg text-gray-600 leading-relaxed max-w-lg mx-auto px-4">
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                  ...
                  >
                    <div className="w-20 h-20 rounded-full flex items-center justify-center bg-opacity-10" style={{ backgroundColor: `${step.accent}20` }}>
                      <step.icon className="w-8 h-8" style={{ color: index === 2 ? '#FE9170' : '#0a0a0a' }} strokeWidth={1.5} />
                    </div>
                  </div>
