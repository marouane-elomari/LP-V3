        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-16">
          ...
          <div className="relative py-[5px]">
            ...
            <div className="flex flex-col gap-3 mb-12">
              <Link to={`/${language}/manifesto`} className="text-gray-400 hover:text-white transition-colors text-sm">{t('footer.manifesto')}</Link>
              <a href="https://www.cal.eu/luuzon/30min" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors text-sm">{t('footer.contact')}</a>
            </div>
